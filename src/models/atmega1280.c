...
static struct avr_register regmap[] = {
	...
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR0A  (0x47)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR0B  (0x48)
	...
	{ .type = REG_ATOMIC_LOW },        // TCNT1L (0x84)
	{ .type = REG_ATOMIC_HIGH },       // TCNT1H (0x85)
	{ .type = REG_VALUE },             // ICR1L (0x86)
	{ .type = REG_VALUE },             // ICR1H (0x87)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR1AL (0x88)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR1AH (0x89)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR1BL (0x8a)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR1BH (0x8b)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR1CL (0x8c)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR1CH (0x8d)
	...
	{ .type = REG_ATOMIC_LOW },        // TCNT3L (0x94)
	{ .type = REG_ATOMIC_HIGH },       // TCNT3H (0x95)
	{ .type = REG_VALUE },             // ICR3L (0x96)
	{ .type = REG_VALUE },             // ICR3H (0x97)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR3AL (0x98)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR3AH (0x99)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR3BL (0x9a)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR3BH (0x9b)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR3CL (0x9c)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR3CH (0x9d)
	...
	{ .type = REG_ATOMIC_LOW },        // TCNT4L (0xa4)
	{ .type = REG_ATOMIC_HIGH },       // TCNT4H (0xa5)
	{ .type = REG_VALUE },             // ICR4L (0xa6)
	{ .type = REG_VALUE },             // ICR4H (0xa7)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR4AL (0xa8)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR4AH (0xa9)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR4BL (0xaa)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR4BH (0xab)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR4CL (0xac)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR4CH (0xad)
	...
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR2A  (0xb3)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR2B  (0xb4)
	...
	{ .type = REG_ATOMIC_LOW },        // TCNT5L (0x124)
	{ .type = REG_ATOMIC_HIGH },       // TCNT5H (0x125)
	{ .type = REG_VALUE },             // ICR5L (0x126)
	{ .type = REG_VALUE },             // ICR5H (0x127)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR5AL (0x128)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR5AH (0x129)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR5BL (0x12a)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR5BH (0x12b)
	{ .type = REG_TIMER5_LOW_BUFF },   // OCR5CL (0x12c)
	{ .type = REG_TIMER5_HIGH_BUFF },  // OCR5CH (0x12d)

...
static struct avr_timer timers[] = {
    {   // timer 0
        ...
        .clock_src      = { AVR_CS_DISABLED, AVR_CS_PRESCALE(1), AVR_CS_PRESCALE(8), AVR_CS_PRESCALE(64), AVR_CS_PRESCALE(256), AVR_CS_PRESCALE(1024), AVR_CS_FALLING, AVR_CS_RISING },
        .reg_tcnt       = 0x46,
        .reg_ocra       = 0x47,
        .reg_ocrb       = 0x48,
        .reg_ocrc       = 0,

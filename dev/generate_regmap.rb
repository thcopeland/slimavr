...
def_matcher :try_match_value, "REG_VALUE", /PORT[A-Z]|DDR[A-Z]|PIN[A-Z]|SREG|SPH|SPL|EINT|RAMPZ|GPIOR\d+|GTCCR|ICR\d+[HL]?|TCNT\d+ |TCCR\d+[A-C]|TIMSK\d+|EIND|RAMPZ|EEAR[HL]?|EEDR/
